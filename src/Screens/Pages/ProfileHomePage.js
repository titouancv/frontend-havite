        ...
        <View className="h-full flex-col w-full space-y-4">
            ...
            <View className="w-[95%] self-center">
              <View className="w-full bg-primary flex-col justify-center items-center rounded-lg p-4 py-4 space-y-2">
                <View className="rounded-lg w-full p-1 border-4 border-light-1 flex justify-center self-center" style={{backgroundColor: authData.primaryColor}}>
                ...
                <View className="w-full space-y-2">
                  <TouchableOpacity className="border-4 border-secondary rounded-lg p-1" onPress={() => navigation.navigate("AccountSettingsPage") }>
                    <Text className="text-caption-text font-bold text-secondary self-center">Account settings</Text>
                  </TouchableOpacity>
                </View>
              </View>
            </View>
